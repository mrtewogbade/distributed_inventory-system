...
__decorate([
    (0, microservices_1.MessagePattern)('auth.validate'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_d = typeof shared_1.ValidateTokenDto !== "undefined" && shared_1.ValidateTokenDto) === "function" ? _d : Object]),
    __metadata("design:returntype", Promise)
...
const prisma_service_1 = __webpack_require__(/*! ./prisma/prisma.service */ "./apps/auth/src/prisma/prisma.service.ts");
const rpc_exception_filter_1 = __webpack_require__(/*! ./filters/rpc-exception.filter */ "./apps/auth/src/filters/rpc-exception.filter.ts");
...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            { provide: 'APP_FILTER', useClass: rpc_exception_filter_1.RpcExceptionFilter },
        ],
    })
], AuthModule);
...
let AuthService = class AuthService {
    ...
    async register(registerDto) {
        try {
            ...
            throw new common_1.UnauthorizedException('Registration failed due to an unexpected error', error.message);
        }
    }
    async login(loginDto) {
        try {
            ...
            throw new common_1.UnauthorizedException('Login failed due to an unexpected error', error.message);
        }
    }
    async validateToken(validateTokenDto) {
        try {
...
/***/ "./apps/auth/src/filters/rpc-exception.filter.ts":
/*!*******************************************************!*\
  !*** ./apps/auth/src/filters/rpc-exception.filter.ts ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const microservices_1 = __webpack_require__(/*! @nestjs/microservices */ "@nestjs/microservices");
let RpcExceptionFilter = class RpcExceptionFilter extends microservices_1.BaseRpcExceptionFilter {
    catch(exception, host) {
        console.error(...oo_tx(`2815586246_7_4_7_49_11`, 'Caught exception:', exception));
        if (exception instanceof microservices_1.RpcException) {
            return super.catch(exception, host);
        }
        return super.catch(new microservices_1.RpcException('An unexpected error occurred'), host);
    }
};
...
async function bootstrap() {
    ...
    await app.listen();
    console.log(...oo_oo(`3742804361_13_2_13_52_4`, 'Auth Microservice running with NATS'));
}
bootstrap();
;
function oo_cm() { try {
