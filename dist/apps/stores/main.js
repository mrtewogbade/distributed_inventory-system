...
/***/ "./apps/stores/prisma/prisma.service.ts":
/*!**********************************************!*\
  !*** ./apps/stores/prisma/prisma.service.ts ***!
  \**********************************************/
...
/***/ "./apps/stores/src/stores.controller.ts":
/*!**********************************************!*\
  !*** ./apps/stores/src/stores.controller.ts ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const stores_service_1 = __webpack_require__(/*! ./stores.service */ "./apps/stores/src/stores.service.ts");
let StoresController = class StoresController {
    ...
    async createStoreRole(data) {
        await this.storesService.validateToken(data.token);
        return this.storesService.createStoreRole(data.storeId, data.userId, data.dto);
    }
    async addUserToStore(data) {
        await this.storesService.validateToken(data.token);
        return this.storesService.addUserToStore(data.storeId, data.userId, data.dto);
    }
...
__decorate([
    (0, microservices_1.MessagePattern)('stores.get'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], StoresController.prototype, "getStore", null);
__decorate([
    (0, microservices_1.MessagePattern)('stores.create_role'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], StoresController.prototype, "createStoreRole", null);
__decorate([
    (0, microservices_1.MessagePattern)('stores.add_user'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], StoresController.prototype, "addUserToStore", null);
__decorate([
    (0, microservices_1.MessagePattern)('stores.update_verification'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
/***/ "./apps/stores/src/stores.module.ts":
/*!******************************************!*\
  !*** ./apps/stores/src/stores.module.ts ***!
  \******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const stores_controller_1 = __webpack_require__(/*! ./stores.controller */ "./apps/stores/src/stores.controller.ts");
const stores_service_1 = __webpack_require__(/*! ./stores.service */ "./apps/stores/src/stores.service.ts");
const prisma_service_1 = __webpack_require__(/*! ../prisma/prisma.service */ "./apps/stores/prisma/prisma.service.ts");
...
/***/ "./apps/stores/src/stores.service.ts":
/*!*******************************************!*\
  !*** ./apps/stores/src/stores.service.ts ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
let StoresService = class StoresService {
    ...
    async validateToken(token) {
        console.log(...oo_oo(`2744440113_52_4_52_43_4`, 'Validating token:', token));
        try {
            const result = await (0, rxjs_1.firstValueFrom)(this.authClient.send('auth.validate_token', { token }));
            console.log(...oo_oo(`2744440113_57_6_57_53_4`, 'Token validation result:', result));
            return result;
        }
        catch (error) {
            console.error(...oo_tx(`2744440113_60_6_60_53_11`, 'Token validation error:', error));
            throw new common_1.UnauthorizedException('Invalid token', error instanceof Error ? error.message : String(error));
        }
    }
    async createStore(userId, dto) {
        ...
        const adminRole = await this.prisma.storeRole.create({
            data: {
                ...
                title: 'Admin',
                permissions: [
                    shared_1.Permission.VIEW_STORE,
                    shared_1.Permission.MANAGE_USERS,
                    shared_1.Permission.VIEW_INVENTORY,
                    shared_1.Permission.EDIT_INVENTORY,
                    shared_1.Permission.VIEW_ORDERS,
                    shared_1.Permission.EDIT_ORDERS,
                ],
            },
        });
    ...
    async createStoreRole(storeId, userId, dto) {
        const membership = await this.prisma.storeMember.findFirst({
            where: { storeId, userId },
            include: { role: true },
        });
        if (!membership ||
            !membership.role?.permissions.includes(shared_1.Permission.MANAGE_USERS)) {
            throw new common_1.ForbiddenException('Only admins can create roles');
        }
    ...
    async addUserToStore(storeId, userId, dto) {
        const store = await this.prisma.store.findUnique({
            where: { id: storeId },
        });
        if (!store?.isVerified) {
            throw new common_1.ForbiddenException('Store must be verified to add users');
        }
        ...
        if (!requesterMembership ||
            !requesterMembership.role?.permissions.includes(shared_1.Permission.MANAGE_USERS)) {
            throw new common_1.ForbiddenException('Only admins can add users to a store');
        }
        const existingMembership = await this.prisma.storeMember.findFirst({
            where: { storeId, userId: dto.userId },
        });
        if (existingMembership) {
            throw new common_1.UnauthorizedException('User is already a member of this store');
        }
...
/*!*********************************!*\
  !*** ./apps/stores/src/main.ts ***!
  \*********************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
const core_1 = __webpack_require__(/*! @nestjs/core */ "@nestjs/core");
const microservices_1 = __webpack_require__(/*! @nestjs/microservices */ "@nestjs/microservices");
const stores_module_1 = __webpack_require__(/*! ./stores.module */ "./apps/stores/src/stores.module.ts");
async function bootstrap() {
    ...
    await app.listen();
    console.log(...oo_oo(`2497631262_13_2_13_54_4`, 'Stores Microservice running with NATS'));
}
bootstrap();
;
function oo_cm() { try {
